...
//		System.out.println(testPath);
		...
		Path path1 = Paths.get("server", "dir1","test-file-1.txt");
		Path path2 = Paths.get("server", "dir1","test-file-2.txt");
//		System.out.println(path1);
//		System.out.println(path2);
		String root = "client";
		Path dirPath = Paths.get(root, "1.txt");
...
//		}).forEach(System.out::println);
		...
		// reading
		Path server = Paths.get("server", "test-file-1.txt");
